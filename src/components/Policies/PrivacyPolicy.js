...
export const PrivacyPolicy = () => {
  return (
    <div>
     ...
     <p> We value the trust you place in us. That's why we insist upon the highest standards for secure transactions and User information privacy. Please read the following statement to learn about our information gathering and dissemination practices. The following Privacy Policy should be read along with the Terms of Use for a full understanding of the company's practices as well as the Users responsibilities when interacting with the site <Link to="/">nerchapetti.com </Link> </p>
...
<p>
We and our affiliates will share, part with and allow any other business entity to use the personal information provided by the User to this company, in the event we (or our assets) plan to merge with, or be acquired by that business entity, or re-organization, amalgamation, restructuring of business. Should such a transaction occur that other business entity (or the new combined entity) will be required to follow this privacy policy with respect to your personal information.
</p>
...
<p>
To report an abuse on the Website, not being a cyber security incident, a User may write to is immediately and provide details of the abuse. Upon receiving such information we will examine the abuse and take suitable and necessary steps to remedy it.
</p>
...
<p>
If at any time a User wishes to review the information provided to us at the time of registering with nerchapetti.com or at any time thereafter, you may do so by signing into your account and amending the same
</p>
...
<p>
If you want to deactivate your account or remove your contact information from all lists and newsletters, please write to us at support@nerchapetti.com
</p>

<h2>
7. Advertisements on Nerchapetti.com
</h2>
...
<p>
The donors/contributors hereby permit us to share their personal information such as name, email address, contact information to the respective Campaigner and beneficiaries of the donations made by the donors via nerchapetti.com
</p>
<p>
By continuing to the next step you are willingly giving us permission to contact you via WhatsApp, Email, SMS, and other modes of communication.
</p>
...
<p>
Information provided by you to nerchapetti.com is processed, stored and retained through our servers and web hosts being hostinger.com
</p>
...
<p>
Vengal, Veera Marthanda Varma Road, Podiyadi P. O. <br />
Thiruvalla, Kerala – 689 110 (India)  <br />
Email: AllenVengal@gmail.com <br />
Time: Mon - Fri (9:00 - 16:00) <br />
</p>
</div>
      <Footer />
    </div>
